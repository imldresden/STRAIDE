    ...
    parts.forEach(function(it){
        s += '<div class="col">';
            s += '<div class="card h-100">';
                ...
                s += '</div>';
                if(typeof it.file !== 'undefined'){
                    s += '<div class="card-body d-grid">';
                        s += '<a class="btn btn-primary" type="button" href="files/' + it.file + '" download="' + it.file + '"><i class="bi bi-cloud-arrow-down-fill"></i> Download ' + it.type + '</a>';
                    s += '</div>';
                }
