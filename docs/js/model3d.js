    ...
    constructor(){
        ...
        let loadBJS = new Promise((resolve, reject) => {
            try{
                ...
                bjs.src = 'https://preview.babylonjs.com/babylon.js';
                bjs.async = false;
        ...
        let loadGLTFAux = function(file){
            ...
            meshTask.onSuccess = function (task){
                ...
                const center = task.loadedMeshes[1].getBoundingInfo().boundingBox.center;
                ...
                //task.loadedMeshes[1].position = new BABYLON.Vector3(-center.x/2, -center.y/2, -center.z/2);
                //task.loadedMeshes[1].rotation = new BABYLON.Vector3(90,0,0);
